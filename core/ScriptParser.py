...
class Script:
    ...
    type_keyword_position = {
        ...
        'RichText'      :['fontfile','fontsize','color','line_limit','scale','sub_key','sub_icon','label_color'],
    ...
    type_keyword_default = {
        ...
        'BezierCurve'   :[[100,100],[[100,100]],[[-100,-100]],[[400,400]],[30],['linear']],
        ...
        'RichText'      :['./assets/SourceHanSansCN-Regular.otf',40,[0,0,0,255],20,1.0,['Key1'],['./assets/icon.png'],'Lavender'],
