...
def open_media_def_window(father,image_canvas,available_Text,available_Pos,available_Bubble,available_Anime,used_variable_name,i_name='',i_type='',i_args=''):
    ...
    def comfirm_obj():
        ...
        if '' in [o_name.get(),o_type.get()]:
            ...
            get_args = {
                ...
                'align':align.get(),'fill_mode':fill_mode.get(),'fit_axis':fit_axis.get(),
    ...
    arg_tplt = {
        ...
        'StrokeText':"(fontfile='{fontfile}',fontsize={fontsize},color={color},line_limit={line_limit},edge_color={edge_color},edge_width={edge_width},projection='{projection}',label_color='{label_color}')",
        ...
        'DynamicBubble':"(filepath='{filepath}',Main_Text={Main_Text},Header_Text={Header_Text},pos={pos},mt_pos={mt_pos},mt_end={mt_end},ht_pos={ht_pos},ht_target={ht_target},fill_mode='{fill_mode}',fit_axis='{fit_axis}',line_distance={line_distance},label_color='{label_color}')",
    ...
    fit_axis = tk.StringVar(Objdef_windows)
    ...
    projection = tk.StringVar(Objdef_windows)
    ...
    ttk.Label(StrokeText_frame,text='投影方向').place(x=10,y=190,width=65,height=25)
    ...
    ttk.Combobox(StrokeText_frame,textvariable=projection,value=['C','E','W','N','S','NE','NW','SE','SW']).place(x=75,y=190,width=160,height=25)
    ...
    ttk.Label(StrokeText_frame,text='(选择)',anchor='center').place(x=240,y=190,width=50,height=25) # align
    ...
    ttk.Label(DynamicBubble_frame,text='适应模式').place(x=10,y=310,width=65,height=25)
    # 中
    ...
    ttk.Combobox(DynamicBubble_frame,textvariable=fit_axis,value=['free','vertical','horizontal']).place(x=75,y=310,width=160,height=25)
    # 右
    ...
    ttk.Label(DynamicBubble_frame,text='(选择)',anchor='center').place(x=240,y=310,width=50,height=25) # align
    # ChatWindow_frame
    # 左
